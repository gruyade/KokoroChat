...
- [ ] 13. ファイル添付実装
  ...
  - [ ] 13.3 Tauri Commands（Attachment）実装
...
- [ ] 15. Checkpoint - バックエンド全機能確認
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 16. AppState・Tauriエントリーポイント統合
  - [ ] 16.1 AppState定義とmain.rs統合
