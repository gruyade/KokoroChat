...
- [x] 21. Checkpoint - フロントエンド確認
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 22. CI/CD・ドキュメント
  - [x] 22.1 GitHub Actions CI設定
